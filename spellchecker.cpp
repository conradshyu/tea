...
QStringList CSpellchecker::get_speller_modules_list()
{
  ...
  //qDebug() << "CSpellchecker::get_speller_modules_list()  -start";
...
//         qDebug()	<< entry->name;
  ...
  //qDebug() << "CSpellchecker::get_speller_modules_list()  -end";
...
{
//qDebug() << "CHunspellChecker::get_speller_modules_list() - start";
 ...
 // if (! initialized)
  ...
  //qDebug() << "CHunspellChecker::get_speller_modules_list() " << fil.size();

  //qDebug() << "CHunspellChecker::get_speller_modules_list() - end";
